...
public class DropItem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject Boxitem = Shared.dataMgr.ChestItem();
    ...
    void Update()
    {
        if (Input.GetKeyUp(KeyCode.E) && ItemPick == true)
        {
            ...
            else if (Shared.gameMgr.GetComponent<inven>().PickUpItem(item))
            {
                Shared.dataMgr.UnlockListUpdate(item.data.itemNumber);
                Destroy(gameObject);
            }
        }
